...
\begin{figure*}
\subfloat[Geometry for Image-Charge Shifts]{
   \raisebox{0.9cm}{\includegraphics[width=.9\columnwidth]{img.exp/Simplified-Images}\label{fg:shiftsgeom}}
   }
\subfloat[Transport Gap Renormalization]{
   \includegraphics[width=.88\columnwidth]{img/SingleGapPlot3_eV}\label{fg:shiftscalc}
   }
\caption{
